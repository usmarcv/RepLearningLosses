...
class VisionTransformer32(nn.Module):
    def __init__(self, img_size=32, patch_size=4, embed_dim=256, hidden_dim=2048, feat_dim=128, num_classes=10):
        ...
        self.vit = timm.create_model(
            ...
            num_classes=num_classes             # Sem cabeça de classificação padrão
        )
